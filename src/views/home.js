...
return (
    <View style={styles.container}>
        ...
        <Image source={ufcLogo} style={{ width: 200, height: 50, resizeMode: 'contain', margin:30 }} />
        ...
        <TouchableHighlight style={styles.listTouch} activeOpacity={0.6} underlayColor={'#edfffe'} onPress={()=>{navigation.push('Questions')}}>
